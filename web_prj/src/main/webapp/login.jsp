							...
							<div class="card shadow-lg border-0 rounded-lg mt-5">
								...
								<div class="card-body">
									...
									<form method="post"
										...
										<!-- pagecode는 서블릿으로 넘어갈 것이니.. -->
										<div class="form-floating mb-3">
											<input name="userid" class="form-control" id="inputFirstName"
												type="text" placeholder="Enter your ID" /> <label
												for="inputEmail">ID</label>
										</div>
										<div class="form-floating mb-3">
											<input name="passwd" class="form-control" id="inputPassword"
										...
										<div
											...
											<a class="small" href="password.html">Forgot Password?</a> <a
												class="btn btn-primary">Login</a> <input type="submit"
												value="로그인">
										</div>
									</form>
